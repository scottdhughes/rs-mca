...
codeword span has rank at least five and obeys
`sum_i binom(w+s_i+r+e,r)<=binom(R+g-e,r)`.  At rank five it has
`g>=874886`; at rank six it has `g>=87070`; ranks seven and above remain
unpaid, and rank eleven receives no uniform cut over the full shallow
range.  After
