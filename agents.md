...
the exact upper `908116<15775933`; rank six is therefore impossible.  Ranks
seven and above remain unpaid, and rank twelve receives no uniform
first-pivot cut over the full shallow range.  The next varying-`G` theorem
must therefore be a rank-at-least-seven positive-`w` fixed-syndrome secant or
split-rational incidence theorem.  After
