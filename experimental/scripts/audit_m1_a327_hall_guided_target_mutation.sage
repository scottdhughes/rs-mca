#!/usr/bin/env sage
"""Sage gate for the M1 a=327 Hall-guided target mutation packet."""
...
def audit_record():
    ...
    record["sage_gate"] = {
        ...
        "reason": (
            "proxy Hall-guided candidate pending exact lift"
            if record["exact_audit"]["triggered"]
            else "no proxy Hall-guided a>=327 candidate"
        ),
    }
    return record
...
def main():
    ...
    if args.json:
        ...
        print("SAGE_GATE_M1_A327_HALL_GUIDED_TARGET_MUTATION_OK")
