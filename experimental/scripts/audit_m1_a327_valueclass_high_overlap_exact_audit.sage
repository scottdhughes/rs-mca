#!/usr/bin/env sage
"""Exact GF(17^32) pivot-minor audit for selected high-overlap value-class designs."""
...
PROXY_PRIME = 12289
SCANNER_PATH = Path("experimental/scripts/scan_m1_a327_valueclass_high_overlap_beam.py")
SOURCE_DATA_PATH = Path("experimental/data/m1_a327_valueclass_high_overlap_beam.json")
DATA_PATH = Path("experimental/data/m1_a327_valueclass_high_overlap_exact_audit.json")

AUDIT_SELECTION = [
    {
        "candidate_id": "high_overlap_from_boundary_residual_45_c00_b5_200_t00",
        "reason": "best proxy-ranked candidate; lowest compressed-variable count",
    },
    {
        "candidate_id": "high_overlap_from_boundary_residual_45_c00_b5_200_t04",
        "reason": "second low-variable retained candidate with distinct histogram",
    },
    {
        "candidate_id": "high_overlap_from_boundary_residual_45_c00_b5_096_t04",
        "reason": "low-variable residual-split variant",
    },
    {
        "candidate_id": "high_overlap_from_quotient_fiber_45_c15_b5_064_t07",
        "reason": "best quotient-fiber high-overlap retained candidate with nine capped pairs",
    },
    {
        "candidate_id": "high_overlap_from_quotient_fiber_45_c15_b5_064_t03",
        "reason": "quotient-fiber high-overlap candidate with structurally novel histogram",
    },
    {
        "candidate_id": "high_overlap_from_pair_boundary_45_c15_b5_064_t00",
        "reason": "best pair-boundary high-overlap retained candidate with nine capped pairs",
    },
]


def load_scanner():
    spec = importlib.util.spec_from_file_location("valueclass_high_overlap_scanner", SCANNER_PATH)
...
def exact_minor_result(candidate, exact_F, exact_H, exact_powers, proxy_F, proxy_H, proxy_powers, selection_reason):
    ...
    return {
        ...
        "pair_square_score": summary["pair_square_score"],
        "membership_histogram": summary["membership_histogram"],
        "membership_size_support": summary["membership_size_support"],
...
def exact_record():
    ...
    record = {
        ...
        "construction_mode": "valueclass_high_overlap_exact_audit",
...
def main():
    ...
    if args.json:
        ...
        print("SAGE_AUDIT_M1_A327_VALUECLASS_HIGH_OVERLAP_EXACT_AUDIT_OK")
