#!/usr/bin/env sage
"""Sage audit for M1 support-pattern multiplicity-mutation search."""
...
SCANNER_PATH = Path("experimental/scripts/scan_m1_support_pattern_multiplicity_mutation_search.py")
...
def load_scanner():
    spec = importlib.util.spec_from_file_location("m1_multiplicity_scanner", SCANNER_PATH)
...
def main():
    ...
    if args.json:
        ...
        print("SAGE_AUDIT_M1_SUPPORT_PATTERN_MULTIPLICITY_MUTATION_SEARCH_OK")
