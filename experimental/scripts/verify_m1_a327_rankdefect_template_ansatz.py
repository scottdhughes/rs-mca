#!/usr/bin/env python3
"""Verify the M1 a=327 rank-defect template ansatz ledger."""
...
DATA_PATH = Path("experimental/data/m1_a327_rankdefect_template_ansatz.json")
NOTE_PATH = Path("experimental/notes/m1/m1_a327_rankdefect_template_ansatz.md")
...
def verify() -> dict[str, Any]:
    ...
    require(record["source_commit"] == "d7b67e4", "wrong source commit")
    ...
    previous = record["previous_basis_kernel_codesign"]
    require(previous["commit"] == "d7b67e4", "wrong previous commit")
    require(previous["coefficient_kernel_profiles"] == 0, "unexpected previous coefficient kernel")
    require(previous["best_failure_mode"] == "CODESIGN_COEFFICIENT_FULL_RANK", "wrong previous failure")
    ...
    require(search["best_template_id"] == "rankdefect_hyperplane_r0_out6", "wrong best template")
    ...
    require(search["best_failure_mode"] == "RANKDEFECT_COEFFICIENT_FULL_RANK", "wrong best failure")
    require(
    ...
    require(best["template_id"] == "rankdefect_hyperplane_r0_out6", "wrong best candidate template")
    require(best["assignment_strategy"] == "signature_fiber_blocks", "wrong best assignment")
    require(best["support_vector"] == [327, 327, 327, 327, 327, 327, 327], "support mismatch")
    require(best["pair7_counts"] == [215, 215, 215, 215, 215], "pair7 mismatch")
    require(best["max_pair_count"] == 215, "max pair mismatch")
    ...
    require(best["forced_basis_combinations"] == 19026, "wrong best combo count")
...
def main() -> None:
    ...
    if args.json:
        ...
        print(f"PASS: M1 a=327 rank-defect template ansatz (status={result['proof_status']})")
