#!/usr/bin/env python3
"""Plan residual-degenerate-class separation diagnostics for M1 a=327."""
...
SOURCE_DATA = Path("experimental/data/m1_a327_dominant_collision_preserving_separation.json")
ROBUST_DATA = Path("experimental/data/m1_a327_robust_proxy_constrained_extraction.json")
OUTPUT_DATA = Path("experimental/data/m1_a327_residual_degeneracy_separation_plan.json")
...
def build_plan(system_limit: int = 3) -> dict[str, Any]:
    ...
    planned = [
        {
            ...
            "analysis": [
                "witness_equivalence_classes",
                "dominant_collision_classes",
                "largest_residual_degenerate_class",
                "quotient_fiber_safe_split_coordinates",
            ],
            "split_families": [
    ...
    return {
        ...
        "construction_mode": "residual_degeneracy_separation_plan",
        "source_commit": SOURCE_COMMIT,
        "baseline": {
            "best_degenerate_capacity_upper_bound": source["separation_search"]["best_capacity_upper_bound"],
