#!/usr/bin/env sage
"""Sage proxy-rank audit for the M1 a=327 boundary value-class search."""
...
def proxy_record():
    ...
    record["sage_audit"] = {
        ...
        "status": "SAGE_PROXY_BOUNDARY_REDUCED_RANK_GATE",
    }
...
def main():
    ...
    if args.json:
        ...
        print("SAGE_AUDIT_M1_A327_VALUECLASS_BOUNDARY_SEARCH_OK")
